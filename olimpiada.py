...
class AdminAddTest(StatesGroup):
    ...
    waiting_for_question_time = State() # Har bir savol vaqti
...
async def begin_test_session(callback: CallbackQuery, state: FSMContext, bot: Bot):
    ...
    async with async_session() as session:
        ...
        for index, q in enumerate(questions):
            ...
            # Har bir savol uchun belgilangan soniya kutish
...
async def admin_save_answers_and_test(message: Message, state: FSMContext):
    ...
    async with async_session() as session:
        new_test = Test(
            ...
            mode="question_timer",
            question_time_seconds=data.get("question_time_seconds", 15),
